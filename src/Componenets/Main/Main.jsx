  ...
  const Data = [
    {
      ...
      fees: "LKR 3,450",
      description:
        "Discover the ancient capital with its iconic stupas and sacred relics.",
    },
    {
      id: 2,
      imgSrc: ella,
    ...
    },
    {
      ...
      fees: "LKR 4,200",
      description:
        "A colonial-era fort offering stunning views of the Indian Ocean.",
    },
    {
      id: 4,
      imgSrc: horton,
      ...
      fees: "LKR 3,900",
      description:
        "A UNESCO site featuring scenic trails and the famous World's End.",
    },
    {
      id: 5,
      imgSrc: mirissa,
      ...
      fees: "LKR 2,500",
      description:
        "A picturesque beach town perfect for whale watching and relaxation.",
    },
    {
      id: 6,
      imgSrc: nuwaraeliya,
      ...
      fees: "LKR 3,600",
      description:
        "Known as 'Little England,' a cool escape amidst tea plantations.",
    },
    {
      id: 7,
      imgSrc: polonnaruwa,
      ...
      fees: "LKR 4,750",
      description:
        "A historic city featuring impressive ruins and ancient temples.",
    },
    {
      id: 8,
      imgSrc: sigiriya,
    ...
    },
    {
      ...
      fees: "LKR 3,000",
      description:
        "A sacred Buddhist site housing the tooth relic of Lord Buddha.",
    },
    {
      id: 10,
      imgSrc: yaala,
      ...
      fees: "LKR 4,600",
      description:
        "Explore the wildlife haven, home to leopards and elephants.",
    },
  ];
  return (
